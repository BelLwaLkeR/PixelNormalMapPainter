...
namespace MyFrameWork
{
    ...
    public class Material
    {
        ...
        public void SetParameter(string uniformName,Vector2 value)
        {
            gl.Uniform2(program.Uniform(uniformName), value.X, value.Y);   
        }

        public void SetParameter(string uniformName, Vector3 value)
        {
        ...
        public void SetParameter(string uniformName, Vector4 value)
        {
