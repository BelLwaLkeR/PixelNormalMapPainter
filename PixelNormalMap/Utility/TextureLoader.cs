...
namespace MyFrameWork
{
    ...
    public class GLTexture : Asset, INotifyPropertyChanged
    {
        private OpenGL gl;
        uint[] id;
...
//                gl.Disable(OpenGL.GL_TEXTURE_2D);
    ...
    public class TextureLoader
    {
        ...
        public  static Texture create(string fileName)
        {
            ...
            //Bitmap gImage1 = new Bitmap((Bitmap)System.Drawing.Bitmap.FromStream(fs));
           // fs.Close();
            // Bitmap gImage1 = new Bitmap(fileName);
            ...
            //BitmapData gbitmapdata = gImage1.LockBits(rect, System.Drawing.Imaging.ImageLockMode.ReadWrite, gImage1.PixelFormat);
            ...
            BitmapDecoder dec = BitmapDecoder.Create(fs,
                BitmapCreateOptions.PreservePixelFormat,
                BitmapCacheOption.Default);
            string f = dec.Frames[0].Format.ToString();
//            if(dec.Frames[0].Format == System.Windows.Media.PixelFormats.)
